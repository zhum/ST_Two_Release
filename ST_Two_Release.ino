...
// for tetris
uint8_t fig=0, pos=0, height=0, angle=0, nextMoveTime=0;
uint8_t tetrisSpeed=500, quitTimeout=3000;
uint8_t last_left=LOW,last_right=LOW;
uint8_t left_button, right_button, bpTime;
